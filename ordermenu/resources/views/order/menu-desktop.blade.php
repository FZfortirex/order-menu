  ...
  <script>
    ...
    function renderMenu(items) {
      ...
      items.forEach(item => {
        ...
        menuContainer.innerHTML += `
          <div 
            class="menu-item bg-white p-4 shadow rounded-xl flex items-center border border-black h-44 transition ${isOutOfStock ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100 cursor-pointer'}"
            ...
            <div class="ml-4 flex-1">
              ...
              <div class="flex justify-between items-center mt-1">
                <p class="text-sm ${isOutOfStock ? 'text-red-500 font-bold' : ''}">
