...
<!-- Tombol Buat Akun -->
<div class="mb-6">
    <a href="{{ route('create-accounts.index') }}" class="inline-block bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-2 rounded-lg shadow transition duration-200">
        + Buat Akun Pelanggan
    </a>
</div>
