...
<body class="min-h-screen bg-gradient-to-br from-red-900 to-indigo-200 px-4 py-6 font-sans">

  <!-- Tombol Back -->
  <a href="javascript:history.back()" class="mb-4 inline-flex items-center text-gray-100 text-sm font-medium hover:underline">
    ← Kembali
  </a>
